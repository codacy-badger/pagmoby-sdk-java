...
public class Entry {
    ...
    public PagMobyAccount getPagMobyAccount() { return pagmobyAccount; }

    public String getAccountPagMobyAccount() { return pagmobyAccount.getAccount(); }
    ...
    public int getPagMobyAccountId() { return pagmobyAccountId; }
    ...
    public String toString() {
        return new StringBuilder("Entry{")
                ...
                .append(", pagmobyAccount={ account").append(pagmobyAccount)
                .append(", fees=").append(fees)
                .append(", type=").append(type)
                .append(", grossAmount=").append(grossAmount)
                .append(", pagmobyAccountId=").append(pagmobyAccountId)
