...
public class Multipayments {
    ...
    /**
     * This method is used to capture a pre-authorized multipayment by its PagMoby multipayment external ID.
     *
     * @param   multipaymentId
     *          {@code String} the PagMoby multipayment external ID.
     *
     * @param   setup
    ...
    /**
     * This method is used to cancel a pre-authorized multipayment by its PagMoby multipayment external ID.
     *
     * @param   multipaymentId
     *          {@code String} the PagMoby multipayment external ID.
     *
    ...
    /**
     * This method allows you to get the data of a created multipayment by its PagMoby multipayment external ID.
     *
     * @param   multipaymentId
     *          {@code String} the PagMoby multipayment external ID.
     *
