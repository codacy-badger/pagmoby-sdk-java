...
import br.com.pagmoby.sdk.java.models.error.ErrorBuilder;
...
public class Payments {
     ...
     *
     * @param   orderId
     *          {@code String} the PagMoby order external ID.
     *
     * @param   setup
    ...
    /**
     * This method is used to capture a pre-authorized payment by its PagMoby payment external ID.
     *
     * @param   paymentId
     *          {@code String} the PagMoby payment external ID.
     *
     * @param   setup
     *          {@code Setup} the setup object.
     *
    ...
    /**
     * This method is used to cancel a pre-authorized payment by PagMoby payment external ID.
     *
     * @param   paymentId
     *          {@code String} the PagMoby payment external ID.
     *
    ...
    /**
     * This method is used to get the data of a created payment by PagMoby payment external ID.
     *
     * @param   paymentId
     *          {@code String} the PagMoby payment external ID.
     *
     ...
     * send the PagMoby payment external ID and the amount value.
     *
    ...
    public Map<String, Object> authorize(String paymentId, int amount, Setup setup) {
        if (setup.getEnvironment() == PRODUCTION_URL) {
            this.requestMaker = new RequestMaker(setup);
            RequestProperties props = new RequestPropertiesBuilder()
                    .method("GET")
