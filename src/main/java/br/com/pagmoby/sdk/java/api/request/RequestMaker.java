...
import br.com.pagmoby.sdk.java.api.response.Response;
import br.com.pagmoby.sdk.java.auth.Authentication;
import br.com.pagmoby.sdk.java.exception.PagMobyAPIException;
import br.com.pagmoby.sdk.java.exception.UnauthorizedException;
import br.com.pagmoby.sdk.java.exception.UnexpectedException;
...
import br.com.pagmoby.sdk.java.utilities.ssl.SSLSupport;
...
public class RequestMaker extends PagMoby {

    private final String pagmobyEnvironment;
    ...
    /**
     * This constructor sets the PagMoby environment and the authentication
     * received from parameter.
     *
     * @param setup {@code Setup} the setup object.
     *
     * @see br.com.pagmoby.auth.Authentication
     */
    public RequestMaker(Setup setup) {

        this.pagmobyEnvironment = setup.getEnvironment();
     ...
     * establish connection with PagMoby APIResources, authenticate the connection,
     * load the request properties received from parameter, serialize the
     * request object and send it to the API. Finally, this method receive the
     * response JSON and deserialize it into the respective model object,
     * sending the response code and response body to
    ...
    public Map<String, Object> doRequest(final RequestProperties requestProps) {
        ...
        try {
            ...
            URL url = new URL(pagmobyEnvironment + requestProps.endpoint);
            ...
            throw new PagMobyAPIException("Error occurred connecting to PagMoby API: " + e.getMessage(), e);
        }
    }
     ...
     * deserialize JSON returned from PagMoby API to build a
