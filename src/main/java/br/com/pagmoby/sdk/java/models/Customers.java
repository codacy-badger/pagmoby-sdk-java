...
public class Customers {
     ...
     *
     * @param   customerId
     *          {@code String} the PagMoby customer external ID.
     *
     * @param   setup
     ...
     *
     * @param   creditCardId
     *          {@code String} the PagMoby credit card external ID.
     *
     * @param   setup
     *          {@code Setup} the setup object.
     *
    ...
    /**
     * This method is used to get the data of a created customer by PagMoby customer external ID.
     *
     * @param   customerId
     *          {@code String} the PagMoby customer external ID. Ex: CUS-XXXXXXXXXXXX.
     *
     * @param   setup
     *          {@code Setup} the setup object.
     *
