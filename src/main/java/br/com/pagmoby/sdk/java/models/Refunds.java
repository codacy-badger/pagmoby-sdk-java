...
public class Refunds {
    ...
    /**
     * This method is used to get the data of a created refund by PagMoby refund external ID.
     *
     * @param   refundId
     *          {@code String} the PagMoby refund external ID.
     *
     * @param   setup
     *          {@code Setup} the setup object.
     *
    ...
    /**
     * This method is used to get all refunds of an payment by PagMoby payment external ID.
     *
     * @param   paymentId
     *          {@code String} the PagMoby payment external ID.
     *
    ...
    /**
     * This method is used to get all refunds of an order by PagMoby order external ID.
     *
     * @param   orderId
     *          {@code String} the PagMoby order external ID.
     *
