...
public class Transfers {
    ...
    /**
     * This method allows you to create a transfer. You can create a transfer to another PagMoby account or to
     * an bank account.
     *
     * @param   body
    ...
    /**
     * This method is used to revert a transfer made to a PagMoby account.
     *
     * @param   transferId
     *          {@code String} the PagMoby transfer external ID.
     *
     * @param   setup
     *          {@code Setup} the setup object.
     *
    ...
    /**
     * This method is used to get the data of a created transfer by its PagMoby external ID.
     *
     * @param   transferId
     *          {@code String} the PagMoby transfer external ID.
     *
