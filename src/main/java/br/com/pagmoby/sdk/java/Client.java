...
import br.com.pagmoby.sdk.java.ssl.SSLSupport;
import br.com.pagmoby.sdk.java.util.GsonFactory;
...
import static br.com.pagmoby.sdk.java.util.DataHelper.jsonToUrlEncodedString;
...
public class Client {
    ...
    static {
        try {
            InputStream inputStream = Client.class.getResourceAsStream("/pagmobyJavaSDK.properties");
