...
public class BankAccounts {
    ...
    /**
     * This method allows you to get the data of a created bank account by its PagMoby external ID.
     *
     * @param   bankAccountId
     *          {@code String} the PagMoby bank account external ID.
     *
     * @param   setup
    ...
    /**
     * This method allows you to delete a created bank account by its PagMoby external ID.
     *
     * @param   bankAccountId
     *          {@code String} the PagMoby bank account external ID.
     *
