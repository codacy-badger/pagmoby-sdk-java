...
public class Orders {
    ...
    /**
     * This method is used to get the data of a created order by PagMoby order external ID.
     *
     * @param   orderId
     *          {@code String} the PagMoby order external ID. Ex: ORD-XXXXXXXXXXXX
     *
     * @param   setup
     *          {@code Setup} the setup object.
     *
    ...
    /**
     * This method is used to get all payments of an order by its PagMoby order external ID.
     *
     * @param   orderId
