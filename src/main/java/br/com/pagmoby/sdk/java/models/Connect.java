...
public class Connect {
    ...
    /**
     *  This method allows you to generate access token for a PagMoby account. With this access token, you can
     *  make some request involving more than one PagMoby account. Before generate it, you must request
    ...
    /**
     * This method allows you to refresh the access token of a PagMoby account, if you lost the token
     * or it has expired.
     *
     * @param   body
     *          {@code Map<String, Object>} the request body.
